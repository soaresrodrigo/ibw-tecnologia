    ...
    <div class="container astro-SZ7XMLTE">
      ...
      <div class="row astro-SZ7XMLTE">
        ...
        <div class="col-lg-12 social astro-SZ7XMLTE">
          <a href="https://www.instagram.com/ibwtecnologia" target="_blank" class="astro-SZ7XMLTE">${renderComponent($$result, "Instagram", $$Instagram, { "class": "astro-SZ7XMLTE" })}</a>
          <a href="https://www.facebook.com/ibwtecnologia" target="_blank" class="astro-SZ7XMLTE">${renderComponent($$result, "Facebook", $$Facebook, { "class": "astro-SZ7XMLTE" })}</a>
          <a href="#https://www.youtube.com/c/IBWTECNOLOGIA" target="_blank" class="astro-SZ7XMLTE">${renderComponent($$result, "Youtube", $$Youtube, { "class": "astro-SZ7XMLTE" })}</a>
          <a href="https://api.whatsapp.com/message/6DE32KT22KR7D1?autoload=1&app_absent=0" target="_blank" class="astro-SZ7XMLTE">${renderComponent($$result, "Whatsapp", $$Whatsapp, { "class": "astro-SZ7XMLTE" })}</a>
          <a href="https://www.tiktok.com/@ibwtecnologia?lang=pt-BR" target="_blank" class="astro-SZ7XMLTE">${renderComponent($$result, "Tiktok", $$Tiktok, { "class": "astro-SZ7XMLTE" })}</a>
        </div>
      </div>
...
const $$Companies = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<section class="brands section-config bg-white js astro-H5TDZFSD">
  <ul class="container-fluid js-scroll astro-H5TDZFSD">
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DefaultPage", $$DefaultPage, { "title": "Multi tecnologia", "description": "", "class": "astro-J7PV25F6" }, { "default": () => renderTemplate`${maybeRenderHead($$result)}<div class="bg-masterhead divider astro-J7PV25F6">
    ...
    <div class="container astro-J7PV25F6">
      ...
      <div class="row m-2 js astro-J7PV25F6">
        <div class="col-lg-4 col-sm-12 mb-5 js-scroll astro-J7PV25F6">
    ...
    <div class="text-white astro-J7PV25F6">
      <div class="row astro-J7PV25F6">
        ...
        <div class="container astro-J7PV25F6">
          <div class="row mx-auto js astro-J7PV25F6">
            <iframe class="shadow-light col-lg-3 col-sm-12 mb-5 p-0 js-scroll astro-J7PV25F6" src="https://www.youtube.com/embed/0nDdOe7pWlY" title="YouTube video player" height="300px" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
            </iframe>
            <iframe class="shadow-light col-lg-3 col-sm-12 mb-5 p-0 js-scroll astro-J7PV25F6" src="https://www.youtube.com/embed/0nDdOe7pWlY" height="300px" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
            </iframe>
            <iframe class="shadow-light col-lg-3 col-sm-12 mb-5 p-0 js-scroll astro-J7PV25F6" height="300px" src="https://www.youtube.com/embed/0nDdOe7pWlY" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
            </iframe>
    ...
    <div class="container astro-J7PV25F6">
      <div class="row text-secondary js astro-J7PV25F6">
        <div class="col-lg-3 col-sm-12 mb-5 m-1 p-3 mx-auto shadow-light border-top border-white js-scroll astro-J7PV25F6">
          <h2 class="astro-J7PV25F6">300+</h2>
          <p class="text-white astro-J7PV25F6">Clientes atendidos</p>
        </div>
        <div class="col-lg-3 col-sm-12 mb-5 m-1 p-3 mx-auto shadow-light border-top border-warning js-scroll astro-J7PV25F6">
          <h2 class="astro-J7PV25F6">200+</h2>
          <p class="text-warning astro-J7PV25F6">Avaliações</p>
        </div>
        <div class="col-lg-3 col-sm-12 mb-5 m-1 p-3 mx-auto shadow-light border-top border-danger js-scroll astro-J7PV25F6">
          <h2 class="astro-J7PV25F6">100+</h2>
          <p class="text-danger astro-J7PV25F6">Produtos vendidos</p>
        </div>
      </div>
      <div class="row mt-5 js astro-J7PV25F6">
        <div class="col-sm-12 col-lg-3 mx-auto js-scroll astro-J7PV25F6">
          ${renderComponent($$result, "CTAButton", $$CTAButton, { "class": "astro-J7PV25F6" })}
        </div>
      </div>
    </div>
  </section><div class="bg-map js astro-J7PV25F6">
    <section class="container section-address js-scroll astro-J7PV25F6">
      <div class="row astro-J7PV25F6">
  ...
  </div><section class="section-config bg-ibw js astro-J7PV25F6">
    <div class="container js-scroll astro-J7PV25F6">
...
const $$SolucoesEmpresariais = createComponent(async ($$result, $$props, $$slots) => {
  ...
  </div><section class="container space js">
    <!-- Rede -->
    <article class="p-3 row align-items-center justify-content-around js-scroll">
...
const $$Manutencao = createComponent(async ($$result, $$props, $$slots) => {
  ...
  </div><section class="container p-5 js">
    <h2 class="text-center pb-5 text-blue-dark text-uppercase js-scroll">
      Esses são os nossos serviços
    </h2>
    <div class="row mt-2 section-cards">
      <div class="col-lg-4 col-md-6 col-sm-12 mb-5 js-scroll">
  ...
  </section><section class="bg-dark text-white section-config js">
  ...
  </section><section class="section-config bg-ibw js">
    <div class="container js-scroll">
...
const $$Produtos = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DefaultPage", $$DefaultPage, { "title": "Nossos produtos", "description": "", "class": "astro-JCTLNJ7E" }, { "default": () => renderTemplate`${maybeRenderHead($$result)}<div class="bg-shop divider astro-JCTLNJ7E">
    <header class="bg-blur-dark header-config astro-JCTLNJ7E">
      <div class="text-content astro-JCTLNJ7E">
        ...
        <p class="astro-JCTLNJ7E">
          Oferecemos serviços de informática sob medida para atender às suas
          necessidades empresariais. Nossa equipe de especialistas em TI está
          preparada para oferecer suporte técnico, consultoria em TI,
          implantação de tecnologia e gerenciamento de rede para ajudá-lo a
          alcançar seus objetivos de negócios. Entre em contato conosco hoje
          mesmo para saber como podemos ajudá-lo a aproveitar ao máximo as suas
          soluções de TI.
        </p>
      </div>
    </header>
    ...
    <!-- Computador -->
    <article class="js astro-JCTLNJ7E">
      <img src="/images/products/computador.webp" class="js-scroll astro-JCTLNJ7E" height="400" alt="Computador">
      <div class="text-content js-scroll astro-JCTLNJ7E">
    ...
    <!-- Memória -->
    <article class="js astro-JCTLNJ7E">
      <img src="/images/products/memoria.webp" class="js-scroll astro-JCTLNJ7E" height="400" alt="">
    ...
    <!-- SSD -->
    <article class="js astro-JCTLNJ7E">
      <img src="/images/products/ssd.webp" class="js-scroll astro-JCTLNJ7E" height="400" alt="">
    ...
    <!-- Teclado -->
    <article class="js astro-JCTLNJ7E">
      <img src="/images/products/teclado.webp" width="400" class="js-scroll astro-JCTLNJ7E" height="400" alt="">
  ...
  </section><section class="section-config bg-ibw js astro-JCTLNJ7E">
    <div class="container js-scroll astro-JCTLNJ7E">
...
const $$Sobre = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DefaultPage", $$DefaultPage, { "title": "Sobre", "description": "" }, { "default": () => renderTemplate`${maybeRenderHead($$result)}<div class="bg-about divider">
    <header class="bg-blur-dark header-config">
      <div class="text-content">
        <h1>
          Nosso compromisso é prestar serviços de <mark>excelência</mark> para garantir a satisfação de nossos clientes e melhoria de seus negócios.
        </h1>
      </div>
    </header>
  </div><section class="container p-5">
    <article class="row align-items-center justify-content-around js">
      <img src="/icons/about-us.svg" class="order-sm-1 img-fluid col-lg-6 col-md-8 col-sm-12 mb-5 js-scroll" alt="">

      <div class="order-sm-2 col-lg-4 col-sm-12 js-scroll">
  ...
  </section><section class="section-config bg-logo align-items-center justify-content-around js">
    <div class="video-presentation text-blue-dark js-scroll">
      <div class="row">
      ...
      <div class="col-lg-6 col-sm-12 col-md-6 mx-auto mt-5 js-scroll">
...
const $$Faq = createComponent(async ($$result, $$props, $$slots) => {
  ...
  </div><section class="js container faq p-5 astro-6KMWGHHU" id="faq">
    <dl class="faq-lista js-accordion js-scroll astro-6KMWGHHU">
      <dt class="astro-6KMWGHHU">Quanto tempo leva para reparar meu notebook ou computador?</dt>
      <dd class="astro-6KMWGHHU">
        O tempo necessário para reparar seu notebook ou computador pode variar dependendo da complexidade do problema e do tipo de serviço necessário. Geralmente, a maioria dos reparos leva entre <b class="astro-6KMWGHHU">1 a 5 dias úteis</b>.
      </dd>
  ...
  </section><section class="section-config bg-ibw js astro-6KMWGHHU">
    <div class="container js-scroll astro-6KMWGHHU">
